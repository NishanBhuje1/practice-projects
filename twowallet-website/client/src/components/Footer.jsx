      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <a
              href="#"
              className="flex items-center gap-2 font-heading font-bold text-xl text-[#1D9E75] mb-4"
            >
            ...
            <p className="text-sm leading-relaxed mb-6">
              The smart way for couples to manage money together — independence
              and partnership, in balance.
            </p>
            {/* App store badges */}
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-500">
            Made with <span className="text-[#1D9E75]">♥</span> by{" "}
            <a
              href="#"
